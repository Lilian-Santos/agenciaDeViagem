...
O back-end utilizado neste projeto foi disponibilizado pelo curso da **DevMedia**.

A aplicação foi desenvolvida com foco no **Front-end (HTML e CSS)**, enquanto o endpoint responsável pelo recebimento dos dados do formulário foi fornecido pela plataforma para fins de prática e testes de envio (`method="post"` e `action`).
...
![Página Inicial](./layout/pagina-inicial.png)

### 📋 Formulário

![Formulário preenchido](./layout/formulario.jpeg)

### ✉️ Mensagem Do Back-End

![Mensagem do Back-end](./layout/mensagem.png)
